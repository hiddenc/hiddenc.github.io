...
TreeNode.prototype = {
    ...
    deleteNode:function(){
        ...
        this.parent.selfElement.removeChild(this.selfElement); // 移除对应的DOM节点
...
addEvent(root.selfElement, "click",function(e){
    ...
    var domNode = target;
    while(domNode.className.indexOf("nodebody") == -1) domNode = domNode.parentNode; // 找到类名含有nodebody前缀的DOM节点
    ...
    if(resultList.length == 0){
        ...
        for(var x = 0;x<resultList.length;x++){
            ...
            while(pathNode.parent != null){
                if(pathNode.selfElement.className == "nodebody-hidden") pathNode.parent.toggleFold(); // 若是收拢状态，刚展开
...
addEvent(document.getElementById("clear"),"click",function(){
    document.getElementById("searchText").valueOf = "";
...
//初始化查询Demo值
document.getElementById("searchText").valueOf = "JavaScript";
